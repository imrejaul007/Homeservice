/**
 * Full Audit & Improve Workflow
 * Usage: /full-audit [optional description]
 *
...
export const meta = {
  name: 'full-audit',
  description: 'Comprehensive audit: UI polish + backend flow + functionality gaps',
  triggers: ['/full-audit', '/audit', '/comprehensive', '/fix-all'],
};
...
Return: {top_5: [], effort_benefit: []}`, { phase: 'UI: Polish Focus', label: 'polish-focus' }),
  ...
  // ============================================
  // PHASE 2: FULL-STACK/BACKEND AUDIT
  // ============================================
