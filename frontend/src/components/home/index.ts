...
// Legacy exports (kept for backward compatibility but no longer used on homepage)
export { default as HeroSlider } from './HeroSlider';
export { default as AskNilinAI } from './AskNilinAI';
export { default as AIChatWidget, ChatToggleButton } from './AIChatWidget';
