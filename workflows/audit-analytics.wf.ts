/**
 * Analytics Page Audit Workflow
 */

export const meta = {
  name: 'page-audit-analytics',
  description: 'Deep audit of Analytics Page',
  phases: [
...
DEEP FILE DISCOVERY for page: "${pageName}" - Analytics with Provider/Customer/Service analytics charts

Search for ALL files related to Analytics Page:
...
ANALYZE: Chart components, data fetching, state management, TypeScript issues.
...
ANALYZE: Analytics routes, aggregation pipelines, data processing, validation.
READ EACH FILE. Report exact issues with file:line.
...
Return JSON:
{
  "issues": [{
    "severity": "critical|high|medium|low",
    "category": "performance|database|validation",
    "title": "Short title",
    "description": "Detailed description",
...
ANALYZE: Chart data types, API response format, data transformation.
...
ANALYZE: Analytics data format, filter parameters, date ranges.
...
log('═══════════════════════════════════════════════════════════════');
log('  AUDIT REPORT - Analytics Page');
log('═══════════════════════════════════════════════════════════════');
