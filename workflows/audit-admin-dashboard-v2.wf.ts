/**
 * Simplified Admin Dashboard Page Audit
 */

export const meta = {
  name: 'audit-admin-dashboard-v2',
  description: 'Simplified audit of Admin Dashboard',
  phases: [
...
Find all files related to Admin Dashboard in this codebase.

Search for:
1. frontend/src/pages/*admin* or *dashboard*
2. frontend/src/components/**/*admin*
3. frontend/src/components/**/*chart*
4. backend/src/routes/*admin*
5. backend/src/controllers/*admin*
6. backend/src/services/*admin*
