/**
 * Simplified Analytics Page Audit
 */

export const meta = {
  name: 'audit-analytics-v2',
  description: 'Simplified audit of Analytics Page',
  phases: [
...
Find all files related to Analytics Page (Provider/Customer/Service analytics) in this codebase.

Search for:
1. frontend/src/pages/*analytics* or *report*
2. frontend/src/components/**/*analytics*
3. frontend/src/components/**/*chart*
4. backend/src/routes/*analytics*
5. backend/src/routes/*report*
6. backend/src/controllers/*analytics*
7. backend/src/services/*analytics*
...
2. Field name mismatches: serviceId vs _id, serviceName vs name
3. API response data format matches frontend expectations
